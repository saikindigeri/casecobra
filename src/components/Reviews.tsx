...
function ReviewGrid(){
    ...
    return <div ref={containerRef} className="relative -mx-4 mt-16 grid h-[49rem] 
     max-h-[150vh] grid-cols-1 items-start 
     gap-8 overflow-hidden px-4 sm:mt-20
      md:grid-cols-2 lg:grid-cols-3">{isInView?<>
      ...
      msPerPixel={10} />
       <ReviewColumn reviews={[...column2,...column3[1].flat(),...column2]}  
...
<img aria-hidden="true"
 ...
 className="absolute select-none hidden
  xl:block -left-32 top-1/3"/>
  <ReviewGrid/>
    </MaxWidthWrapper>
}